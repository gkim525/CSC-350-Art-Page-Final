...
<body>
  ...
  <div class="navbar">
    ...
    <div class = "container"> 
      ...
      <img src="Images/kanagawa.jpg" alt="Kanagawa painting" style="width:380px;height:300px";>
        </div> 
        <div class="paintingtext"> 
          <h2>The Great Wave off Kanagawa</h2>
          <p>Artist: Katsushika Houkusai</p>
          <p><i>Published: 1831</i></p>
          <p>Price: $35</p>
          <br>  
  ...
  <?php
    $query = "SELECT * FROM art WHERE id=3";
    ...
    if (mysqli_num_rows($result) >= 0) { //if results are greater or equal to 0, print elements in the art table
        ...
        if($row = mysqli_fetch_array($result) ) {
            ...
            <div class="checkoutResultsItem">
                ...
                <form method="post" action="kanagawa.php?action=add&id=<?php echo $row["id"]; ?>"> 
