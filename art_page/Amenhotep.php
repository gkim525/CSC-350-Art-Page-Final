...
<body>
  ...
  <div class="navbar">
    ...
    <div class = "container"> 
      <div class="productimg">
        <img src="Images/Amenhotep.jpg" alt="Amenhotep sculpture" style="width:350px;height:400px;">
      </div> 
      <div class="paintingtext"> 
        <h2>Statue of Amenhotep</h2>
        <p>Artist: Unknown</p>
        <p><i>Published: 1350 B.C.</i></p>
        <p>Price: $835</p>
        <br> 
  ...
  <?php
    $query = "SELECT * FROM art WHERE id=4";
    ...
    if (mysqli_num_rows($result) >= 0) { //if results are greater or equal to 0, print elements in the art table
        ...
        if($row = mysqli_fetch_array($result) ) {
            ...
            <div class="checkoutResultsItem">
                ...
                <form method="post" action="Amenhotep.php?action=add&id=<?php echo $row["id"]; ?>"> 
