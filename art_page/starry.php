...
<body>
    ...
    <br>
     ...
     <div class = "container"> 
      <div class="productimg">
        <img src="Images/StarryNight.jpg" alt="Starry Night painting" style="width:380px;height:470px;">
      </div> 
      <div class="paintingtext"> 
        <h2>Starry Night</h2>
        <p>Artist: Vincent Van Gogh</p>
        <p><i>Published: 1889</i></p>
        <p>Price: $25</p>
        <br> 
  </div>
  </div>  
   ...
   <?php
    $query = "SELECT * FROM art WHERE id=1";
    ...
    if (mysqli_num_rows($result) >= 0) { //if results are greater or equal to 0, print elements in the art table
        ...
        if($row = mysqli_fetch_array($result)) {
            ...
            <div class="checkoutResultsItem">
                ...
                <form method="post" action="starry.php?action=add&id=<?php echo $row["id"]; ?>"> 
